...
def traverse_site(max_links=10):
	...
	while link_parser_singleton.queue_to_parse:
		# If collectd enough links to download images, return
		...
		ba = BeautifulSoup(response)

		for link in BeautifulSoup.findAll(ba, 'a'):
...
def download_images(thread_name):
	...
	while singleton.to_visit:
		...
		http = httplib2.Http()
		print thread_name, 'Starting download images from', url
